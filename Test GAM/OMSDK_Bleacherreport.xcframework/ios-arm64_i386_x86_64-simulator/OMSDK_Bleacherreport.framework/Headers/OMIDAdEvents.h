 ...
 */
@interface OMIDBleacherreportAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDBleacherreportAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDBleacherreportVASTProperties *_Nonnull)vastProperties
