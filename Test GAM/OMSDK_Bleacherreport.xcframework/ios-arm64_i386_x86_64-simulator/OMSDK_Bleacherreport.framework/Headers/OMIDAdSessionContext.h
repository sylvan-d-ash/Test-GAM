 ...
 */
@interface OMIDBleacherreportAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDBleacherreportPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDBleacherreportPartner *)partner
                               ...
                               resources:(NSArray<OMIDBleacherreportVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
