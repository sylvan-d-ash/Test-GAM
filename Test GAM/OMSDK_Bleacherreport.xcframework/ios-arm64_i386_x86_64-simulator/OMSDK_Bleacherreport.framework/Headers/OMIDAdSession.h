 ...
 */
@interface OMIDBleacherreportAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDBleacherreportAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDBleacherreportAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDBleacherreportAdSessionContext *)context
